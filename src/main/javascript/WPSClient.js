    ...
    loadContents:function() {
        ...
        */
        updateCapabilities:function() {
                ...
                for(var i=0; i<this.serviceList.options.length; i++) {                     // Schleife �ber alle WPSServices in der SelectBox
         ...
         */
         updateDescription:function() {
                 ...
                 // Input choices.
                 var wpsService = this.wpsServiceContainer.getService(                                  // holt sich den aktuell ausgew�hlten WPSService
                                 this.serviceList.options[this.serviceList.selectedIndex].value);
                 var processIdentifier = this.processSelection.options[                                 // holt sich den aktuell ausgew�hlten Prozess des aktuell ausgew�hlten WPSService
                 ...
                 var inputs = wpsService.getProcess(processIdentifier).getInputs();                     // holt sich die Inputs den aktuell ausgew�hlten Prozesses
                 ...
                 if(inputs != null) {
                         ...
                         dataTableHeader0.appendChild(document.createTextNode("Input title"));                    // die �berschrift 1 in der div
                         var dataTableHeader1 = document.createElement('th');
                         dataTableHeader1.appendChild(document.createTextNode("Usage"));                          // die �berschrift 2 in der div
                         dataTableHeader1.className = 'usageValue';
                         var dataTableHeader2 = document.createElement('th');
                         dataTableHeader2.appendChild(document.createTextNode("Value"));                          // die �berschrift 3 in der div
                         with(dataTableRow) {
